...
const InferenceApiModal: React.FC<InferenceApiModalProps> = ({
  isOpen,
  onClose,
  onRun,
  imageBase64,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="bg-gray-800 rounded-xl w-full max-w-2xl flex flex-col max-h-[90vh] shadow-2xl border border-gray-700">
        ...
        <div className="p-6 border-b border-gray-700 flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">
              Connect to your own model via HTTP
            </p>
          </div>
          <button
        ...
        <div className="p-6 overflow-y-auto flex-1">
          {showCode && (
            <div className="mb-6 bg-gray-950 border border-gray-700 rounded-lg p-4 relative">
              <button
                onClick={copyTemplate}
                className="absolute top-2 right-2 bg-gray-800 hover:bg-gray-700 text-xs px-2 py-1 rounded border border-gray-600"
              >
                Copy Code
              </button>
          ...
          {/* 👇 FORM — Enter key triggers submit */}
          <form
            className="space-y-4"
            onSubmit={(e) => {
          ...
          >
            ...
            <div className="bg-blue-900/20 border border-blue-800 rounded-lg p-4">
              <h4 className="text-blue-400 text-sm font-bold mb-1">
                Payload Format
              </h4>
              ...
              <h4 className="text-blue-400 text-sm font-bold mt-3 mb-1">
                Expected Response
              </h4>
              <p className="text-blue-200/70 text-xs font-mono">
                [
